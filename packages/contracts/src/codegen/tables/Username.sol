...
library Username {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "Username", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000557365726e616d650000000000000000);
