...
library TowerCounter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "TowerCounter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000546f776572436f756e74657200000000);
