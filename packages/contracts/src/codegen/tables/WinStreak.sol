...
library WinStreak {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "WinStreak", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462617070000000000000000000000057696e53747265616b00000000000000);
