...
library Tower {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "Tower", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000546f7765720000000000000000000000);
